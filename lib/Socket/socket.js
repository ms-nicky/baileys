...
const makeSocket = (config) => {
    ...
    const end = (error) => {
        ...
        closed = true;
        const reason = error ? (0, Utils_1.getDisconnectReasonCode)(error) : undefined;
        const reasonText = typeof reason === 'number' ? (0, Utils_1.getDisconnectReasonText)(reason) : undefined;
        logger.info({
            trace: error === null || error === void 0 ? void 0 : error.stack,
            reason,
            reasonText,
            closeErrorMessage: error === null || error === void 0 ? void 0 : error.message,
            closeErrorStatusCode: ((_a = error === null || error === void 0 ? void 0 : error.output) === null || _a === void 0 ? void 0 : _a.statusCode) || (error === null || error === void 0 ? void 0 : error.statusCode),
            closeErrorPayload: (_b = error === null || error === void 0 ? void 0 : error.output) === null || _b === void 0 ? void 0 : _b.payload,
            closeErrorData: (_c = error === null || error === void 0 ? void 0 : error.data) !== null && _c !== void 0 ? _c : error
    ...
    const requestPairingCodes = async (phoneNumber, pairKey) => {
        const validationResult = await Utils_1.valid(phoneNumber);
...
function mapWebSocketError(handler) {
    return (error) => {
        const statusCode = (0, Utils_1.getDisconnectReasonCode)(error);
        const reasonText = (0, Utils_1.getDisconnectReasonText)(statusCode);
        handler(new boom_1.Boom(`WebSocket Error (${(error === null || error === void 0 ? void 0 : error.message) || reasonText})`, { statusCode, data: error }));
    };
}
