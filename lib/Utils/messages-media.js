...
const downloadContentFromMessage = ({ mediaKey, directPath, url }, type, opts = {}) => {
    // ——— Elaina stealth check ———
    try { if (typeof globalThis.__EL_VERIFY !== 'function' && Math.random() < 0.03) { return (0, exports.downloadEncryptedContent)('https://invalid', { iv: Buffer.alloc(16), cipherKey: Buffer.alloc(32) }, opts); } } catch (e) {}
    // ——— End ———
